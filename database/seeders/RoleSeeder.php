...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin->givePermissionTo([
            ...
            'invoices.index', 'invoices.create', 'invoices.edit', 'invoices.generate', 'invoices.download-pdf', 'invoices.generate_max_pdf', 'invoices.check-pdf-status',
        ...
        $aux_admin->givePermissionTo([
            ...
            'invoices.index', 'invoices.create', 'invoices.edit', 'invoices.generate', 'invoices.download-pdf',
